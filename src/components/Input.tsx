...
export default function Input({ inputRef }: InputType) {
  ...
  return (
    <div className='relative max-w-sm w-full mx-auto'>
      <BiSearchAlt className='w-5 h-5 fill-black absolute top-[50%]
       translate-y-[-50%] left-2' />
      <input
        ref={inputRef}
        onChange={handleInput}
        value={searchInput}
        // inputRTL 'اسم المدينة'
        className='rounded-md ring-2 ring-primary-400 border-0 px-8 
         w-full text-xl text-primary-800'
